...
class ElectionsControllerTest < ActionController::TestCase
  ...
  test "should create election" do
    assert_difference('Election.count') do
      post :create, election: { end: @election.end, name: @election.name, numcand: @election.numcand, start: @election.start }
    end
  ...
  test "should update election" do
    patch :update, id: @election, election: { end: @election.end, name: @election.name, numcand: @election.numcand, start: @election.start }
    assert_redirected_to election_path(assigns(:election))
  end
